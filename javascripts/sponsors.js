var sponsors = [
  ...
  },
  {
    ...
    "bio": "<p>Librato is a complete platform for real-time operations analytics that accepts metrics from any source for real-time aggregation and transformation, anomaly detection, alerting, visual analysis and storage. Librato is dedicated to delivering high performance, beautiful and easy to use tools that make managing your operations more fun and efficient. Librato offers turnkey monitoring solutions for a number of IaaS and PaaS platforms, including AWS, Heroku, and AppHarbor. <a href=\"https://www.librato.com/?utm_campaign=2016-monitorama&utm_content=free-trial&utm_medium=sponsor-page&utm_source=monitorama\">Start your free trial</a> and we’ll hand you back beautiful, interactive dashboards within minutes.</p>",
  },
  {
    "name": "raintank",
    "enabled": true,
  ...
  },
  {
    ...
    "width": 275,
    "bio": "<p>Google Cloud Platform enables developers to build, test and deploy applications on Google’s highly-scalable and reliable infrastructure. Choose from computing, storage and application services for your web, mobile and backend solutions.</p>"
  },
  {
    "name": "chef",
    "enabled": false,
