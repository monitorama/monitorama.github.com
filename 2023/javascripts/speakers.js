var rawSpeakers = {
  "pdx": [
    ...
    },
    {
      ...
      "abstract": "<p>Nobody \"likes\" getting alerts. Best case, it tells you something went (or is about to go) wrong. But more often they're  are meaningless, trivial, or just plain wrong - a source of constant interruptions, false alarms, unplanned work, and noise.</p><p>While some say this is the inherent nature of alerts (and monitoring in general) the truth that well-crafted alerts based on insightful monitoring are a gift - saving hours of investigation and thousands of dollars.</p><p>Whether your organization views alerts a curse or a blessing depends on the design and implementation of those alerts, more so than any specific monitoring tool or technique. And, like most things in technology, good design can be taught and learned.</p><p>In this talk, I'll give a brief tour of the alerting hall of horrors, and then provide real-world, vendor-agnostic techniques to make alerts meaningful, effective, valuable, and actionable (as a bonus, I'll show how to make them manageable, too!). By breaking a few bad habits; understanding how and why vendors put their tools together in particular ways; and learning a few new concepts, you'll have people emailing you to say \"thank goodness I got that alert!\".</p><p>Now there's something you probably don't hear every day.</p>",
      "video": "",
      "slides": "",
    ...
    },
    {
      ...
      "abstract": "<p>In this talk we'll cover:</p><p><ul><li>A light introduction into the history of stress, chronic stress, and stress related disease.</li><li>A deeper dive into stress research and its eery similarities with being on-call.</li><li>Data-driven takeaways from that research for reducing stress during incidents on-call rotations.</li></ul></p>",
      "video": "",
      "slides": "",
    ...
    },
    {
      ...
      "abstract": "<p>Every company has struggled with controlling their Observability costs as the amount of data that needs to be collected, stored and queried in real time has gone up exponentially! Netflix has had to solve this problem as it rapidly scaled into a web scale company with 100m's of customers around the world. In this talk, David will share some of the innovations and strategies Netflix has used to ingest huge amounts of data, while providing sub-second queries to all its Engineers, without bankrupting the company!</p>",
      "video": "",
      "slides": "",
    ...
    },
    {
      ...
      "abstract": "<p>Github Actions is an excellent CI/CD platform, but it's much more than that, it can be used as an effective serverless platform for monitoring. Paired with Microsoft Playwright, an excellent testing platform for web interaction, and a couple of scripts you can quickly and easily build a robust monitoring solution that exercises your entire solution, in and out of the browser. Join me to learn how we've used this pattern to build powerful customized monitoring with minimal time and cost. GitOps monitoring at its finest.</p>",
      "video": "",
      "slides": "",
    ...
    },
    {
      ...
      "abstract": "<p>Quick, what's the difference between the mean, the mode and the median? And which mean do you mean?Do you need a Gaussian or a normal distribution? And does your choice impact the alerts and observations you get from your observability tools?</p><p>Come get refreshed on the impact some basic choices in statistical behavior can have on what gets triggered. Learn why a median might be the choice for historical anomaly or sudden change. Jump into Gaussian distributions, data alignment challenges and the trouble with sampling. Walk out with a deeper understanding of your metrics and what they might be telling you.</p>",
      "video": "",
      "slides": "",
    ...
    },
    {
      ...
      "abstract": "<p>We look at availability, throughput, latency as indicators of health of our systems. Aggregations on top of these measurements help us further reason about their well being by zooming out and looking at how they behave given a meaningful slice of data. We talk about p50, p90 or p99 latency. We use graphs with logarithmic scale. But do we actually understand the math behind these and how to use them with ease?</p><p>In this talk, I will deep dive into just the math you need to know for monitoring.</p>",
      "video": "",
      "slides": "",
    ...
    },
    {
      ...
      "abstract": "<p>When running services in production, the temptation is to keep all the metrics you can. It is difficult to decide in advance what metrics are needed to debug problems, or what system performance metrics will be important in the future. As the saying goes: “It’s better to have it and not need it, than need it and not have it.”</p><p>There are several problems with this. First, it is wasteful; most monitoring data is written once and never read. Second, it can be wildly expensive! I have heard stories of big tech companies that end up spending millions of dollars a year on their monitoring bills, enough to impact the bottom line of the business. It also causes scalability problems, as high-cardinality data sets are notoriously difficult to store and query efficiently.</p><p>But… What if you didn’t need to store this data? What if there was a way to reduce the amount of data but continue to meet your day-to-day requirements? This is the idea behind this talk. It covers experiments that use empirical distributions and samples in place of time series. We will discuss the pros & cons of this approach, and lessons learned trying to apply this in practice.</p>",
      "video": "",
      "slides": "",
    ...
    },
    {
      ...
      "abstract": "<p>Network monitoring is key for understanding your infrastructure, whether that's your home network or a thousand-seat corporate environment. Using its domain-specific scripting language, the Zeek network monitor helps you turn the packets in your network into streams of actionable logs, organized around protocols and themes that matter to you. Zeek is a mature, battle-hardened platform and ecosystem that runs on anything from Raspberry Pi's to to industrial-scale deployments, such as Microsoft Defender</p><p>I am the technical lead for the Zeek project, and in this talk I'll give an overview of Zeek, its architecture and capabilities, and the goals of the project</p>",
      "video": "",
      "slides": "",
